...
export const experience = [
  ...
  },
  {
    ...
    track: "dev",
    points: [
      "Mengembangkan dan memelihara situs web resmi bersama tim pengembang internal.",
      "Menangani antarmuka dan fungsi server secara menyeluruh.",
      "Melakukan pencarian kesalahan, pengujian, dan pemeliharaan rutin agar situs web tetap stabil.",
    ],
    logo: "/iccn.png",
  },
  {
    ...
    track: "dev",
    points: [
      "Mengembangkan aplikasi web untuk klien perusahaan sebagai bagian dari tim pengembangan.",
      "Menggunakan Laravel Breeze untuk autentikasi dan Inertia.js sebagai penghubung antara server Laravel dan antarmuka React.",
      "Mengimplementasikan fitur sesuai kebutuhan klien, lengkap dengan pencarian kesalahan dan pengujian.",
    ],
    logo: "/samaya.png",
  },
  {
    ...
    track: "content",
    points: [
      "Membangun dan mengelola kanal YouTube hingga memiliki lebih dari 200.000 pelanggan.",
      "Menangani pengisi suara, penulisan naskah, dan konsep konten secara mandiri.",
  ...
  },
  {
    ...
    track: "creative",
    points: [
      "Mengedit video pendek maupun panjang dengan standar produksi profesional.",
      "Membuat grafik gerak dan efek visual dengan Adobe After Effects.",
      "Menangani seluruh proses pascaproduksi hingga ekspor sesuai format tiap platform.",
    ],
